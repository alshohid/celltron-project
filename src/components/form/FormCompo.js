...
import Button from '@mui/material/Button';
         ...
         <div className="text-center">
          ...
          <form onSubmit={formSubmitHandler}>
             <div class="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
              <label for="myTextArea" class="block text-sm font-medium text-gray-700">Your Text Area</label>
              <textarea id="myTextArea" name="myTextArea" rows="4" class="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"></textarea>
            </div>
             
             <div className="text-center"><Button variant="outlined">জমা দিন </Button> </div> 
  ...
  //            <textarea className="TextArea-module_textarea_ button__WnLSq TextArea-module_textarea_input__variant_secondary__YXvmt" rows="8">
  //              </textarea>
  //              </div>
  //              </div>
  //              </div>
